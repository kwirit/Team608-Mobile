...
fun main() {
    ...
    initBlock.initIntegerBlock("i")

    val loopBlock = LoopBlock()
    val assignmentBlock = AssignmentBlock()
    assignmentBlock.assignIntegerBlock("i", "i+1")
    val list = mutableListOf<InstructionBlock>()
    list.add(assignmentBlock)

    loopBlock.processInput("i","7","<",list)
